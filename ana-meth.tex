...
\begin{figure}[htbp]
	...
	\subfigure[A long short-term memory cell.]{
		\includegraphics[width=.85\textwidth]{images/LSTM_cell.pdf}
		\label{fig:LSTM_cell}}
	%\vfil
	\quad\quad
	\subfigure[Multi-layer long short-term memory cell configuration.]{
		\includegraphics[width=.55\textwidth]{images/LSTM_multilayer.pdf}
...
\begin{figure}[htbp]
	\centering
	\subfigure[Scaled dot product attention.]{
		\includegraphics[width=.26\textwidth]{images/dot_product_attn.pdf}
		\label{fig:dot_prduct_attn}}
	%\vfil
	\quad\quad
	\subfigure[Multi-head attention.]{
