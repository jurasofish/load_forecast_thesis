...
\begin{figure}[htbp]
	\centering
	\subfigure[Average profiles of every day of the week, using data from 2007 through 2018]{
		\includegraphics[width=.7\textwidth]{images/average-profiles}
		\label{fig:average-profiles}}
	\vfil
	\subfigure[Mean arriving vehicles to Bruny, using data from (???) 2015-2016]{
		\includegraphics[width=.7\textwidth]{images/average-arriving}
		\label{fig:average-arriving}}
	\vfil
	\subfigure[Mean departing vehicles from Bruny, using data from (???) 2015-2016]{
