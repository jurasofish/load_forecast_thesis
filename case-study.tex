...
This case study suggests that the sequence to sequence model offers good overall performance, while the transformer without teacher forcing is capable of out-performing the sequence to sequence model, but at the risk of more variability across the other metrics.
...
The models can be implemented using consumer hardware.
