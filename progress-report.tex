...
The software package will then be extended to simulate the predictions it would make if it were running in the past and present this in an accessible and intuitive format.
