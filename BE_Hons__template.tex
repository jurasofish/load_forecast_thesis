...
\input{Front_All}           %  This has everything in one file
...
\part{Title of first part (optional) if thesis has `parts'} % "Parts" are optional - not normally required. Delete this if not required.
\input{Chapter1}
\input{Chapter2_etc}
